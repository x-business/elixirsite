  ...
  function HashNavigation(_ref) {
    ...
    const setHash = () => {
      ...
      if (
        ...
        const hash =
          slide.getAttribute("data-hash") || slide.getAttribute("data-history");
...
$(".js-copy:not(:disabled)").on("click", function () {
  ...
  btn.html(
    '<svg class="js-copy__icon" width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg"> <g clip-path="url(#clip0_222_1150)"> <path d="M1 7L6 12L17 1" stroke="white" stroke-width="2"/> </g> <defs> <clipPath id="clip0_222_1150"> <rect width="18" height="14" fill="white"/> </clipPath> </defs> </svg> Copied'
  );
  var temp = $("<input>");
  $("body").append(temp);
  ...
  for (var i = 0, file; (file = files[i]); i++) {
    if (file) {
      ...
      reader.onload = function (event) {
        ...
        newAddBtn
          .find(".input-img__label")
          .attr("for", "generator-file-" + countImgBtns);
        newAddBtn
          .find(".input-img__input")
          .attr("id", "generator-file-" + countImgBtns);
        newAddBtn
          .find(".input-img__input")
          .attr("name", "generator-file-" + countImgBtns);
...
function checkProgress() {
  ...
  arr.push({
    name: "file-temp",
    value: JSON.stringify(currentPrediction["file-temp"]),
  });
...
function addContent(data, tokenInfo = true, preloader = true) {
  ...
  $("model-viewer").attr(
    "poster",
    data["data"]["file"]["no_background_images"]
  );
  $(".modal-model-viewer__download-glb").attr(
    "href",
    data["data"]["file"]["model_file"]
  );
  $(".modal-model-viewer__share").attr("data-copy", data["share"]);

  $(".modal-model-viewer__img").remove();
  $.each(data["preview"], function (i, e) {
    $(".modal-model-viewer__images").prepend(
      '<img class="modal-model-viewer__img" src="' + e + '">'
    );
  });
  $(".modal-model-viewer").fadeIn();
